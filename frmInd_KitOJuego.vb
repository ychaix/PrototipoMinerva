Imports clsDataLib
Public Class frmInd_KitOJuego
    Private lista As listInd_KitOJuego
    Private det As clsInd_KitOJuego
    Private bs As New BindingSource
    Private perfilAdmin As Boolean = False
    Private cargado As Boolean = False
    '
    Private Sub frmKitOJuego_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub cargaListado()
        lista = New listInd_KitOJuego
        lista = clsInd_KitOJuegoDB.lista(Proy_Yves.m_Usuario, Proy_Yves.m_Clave, Proy_Yves.m_BaseDato)
        bs.DataSource = lista
        bn.BindingSource = bs
        dgv.DataSource = bs
        '
