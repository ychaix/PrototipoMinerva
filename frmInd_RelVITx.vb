Imports clsDataLib
Public Class frmInd_RelVITx
    Private lista As listInd_RelVITx
    Private det As clsInd_RelVITx
    Private bs As New BindingSource
    Private perfilAdmin As Boolean = False
    Private cargado As Boolean = False
    '
    Private Sub frmTblRelVITx_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub cargaListado()
        lista = New listInd_RelVITx
        lista = clsInd_RelVITxDB.lista(Proy_Yves.m_Usuario, Proy_Yves.m_Clave, Proy_Yves.m_BaseDato)
        bs.DataSource = lista
        bn.BindingSource = bs
        dgv.DataSource = bs
        '
