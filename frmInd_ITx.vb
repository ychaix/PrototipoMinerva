Imports clsDataLib
Public Class frmInd_ITx
    Private lista As listInd_ITx
    Private det As clsInd_ITx
    Private bs As New BindingSource
    Private perfilAdmin As Boolean = False
    Private cargado As Boolean = False
    '
    Private Sub frmTblITx_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub cargaListado()
        lista = New listInd_ITx
        lista = clsInd_ITxDB.lista(Proy_Yves.m_Usuario, Proy_Yves.m_Clave, Proy_Yves.m_BaseDato)
        bs.DataSource = lista
        bn.BindingSource = bs
        dgv.DataSource = bs
        '
