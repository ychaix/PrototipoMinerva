Imports clsDataLib
Public Class frmInd_MetaDatoTraducidoDAtrTx
    Private lista As listInd_MetaDatoTraducidoDAtrTx
    Private det As clsInd_MetaDatoTraducidoDAtrTx
    Private bs As New BindingSource
    Private perfilAdmin As Boolean = False
    Private cargado As Boolean = False
    '
    Private Sub frmInd_MetaDatoTraducidoDAtrTx_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub cargaListado()
        lista = New listInd_MetaDatoTraducidoDAtrTx
        lista = clsInd_MetaDatoTraducidoDAtrTxDB.lista(Proy_Yves.m_Usuario, Proy_Yves.m_Clave, Proy_Yves.m_BaseDato)
        bs.DataSource = lista
        bn.BindingSource = bs
        dgv.DataSource = bs
        '
